...
int main(void)
{
  ...
  {
    tids[4*i] = thread_create(fool, NULL, HIGH_PRIORITY);
    tids[4*i + 1] = thread_create(fool2,NULL,MID_PRIORITY);
    tids[4*i + 2] = thread_create(fool3,NULL,LOW_PRIORITY);
    tids[4*i + 3] = thread_create(fool4,NULL,HIGH_PRIORITY);
  }
